...
### [Backgroud](https://bmcmedinformdecismak.biomedcentral.com/articles/10.1186/s12911-020-1023-5)
...
```{r}
library(rpart)
tree <- rpart(survive ~ EF + creatinine,data=factorData,method="class",control = rpart.control(cp=0.05))
library(rattle)
